...
public:
	...
	void SetLocalWorld(const DirectX::SimpleMath::Matrix& mat) { m_Obj.SetWorldMatrix(mat); }
	...
	const DirectX::SimpleMath::Matrix& GetLocalWorld() { return m_Obj.GetWorldMatrix(); }
